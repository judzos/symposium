...
const setupMobileNav = () => {
  ...
  const syncSections = () => sectionsBtn?.setAttribute("aria-expanded", String(drawerOpen()))
  syncSections()
  ...
  // A sheet must not survive the page under it changing.
  closeSheet()
